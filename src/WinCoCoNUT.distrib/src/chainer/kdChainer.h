...
/////////////////////////////////Data////////////////////////////
 ...
 public:
	...
	int repeat_cluster(double Threshold);

	void set_detect_repeat_flag(){detect_repeat_flag=1;};
	int detect_repeat_cluster_flag;
	void set_detect_repeat_cluster_flag(){detect_repeat_cluster_flag=1;};
	...
	void set_gcfile(char* in_gcfile){gcfile=in_gcfile;};
	...
	void storeChainDB(ProcessFragmentFile* InfoObj,int);
	void storeMultiChainDB(ProcessFragmentFile* InfoObj,int IncludeDirection);
	void storeMultiContigDB(ProcessFragmentFile* InfoObj,int IncludeDirection);
	void storeMultiEstDB(ProcessFragmentFile* InfoObj,int IncludeDirection);
	void silent_chain_traversal();
	void silent_traverse_cluster(child* root, double* maxscoreptr);
